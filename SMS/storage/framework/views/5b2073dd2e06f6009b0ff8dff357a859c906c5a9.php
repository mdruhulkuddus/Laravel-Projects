                ...
                <li class="nav-item dropdown dropdown-large">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                        <div class="user-setting d-flex align-items-center gap-1">
                            ...
                            <img src="<?php echo e(asset($teacherInfo -> image)); ?>" class="user-img" alt="">
                            <div class="user-name d-none d-sm-block text-uppercase"><?php echo e(Session::get('teacherName')); ?></div>
                            <?php else: ?>
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <?php if(Session::get('teacherName')): ?>
                                    <img src="<?php echo e(asset($teacherInfo -> image)); ?>" alt="" class="rounded-circle" width="60" height="60">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="ms-3">
                                        <?php if(Session::get('teacherName')): ?>
                                        <h6 class="mb-0 dropdown-user-name text-capitalize"><?php echo e(Session::get('teacherName')); ?></h6>
...
<?php /**PATH D:\SWE Training\xampp-BITM\htdocs\Laravel\SMS\resources\views/admin/include/header.blade.php ENDPATH**/ ?>